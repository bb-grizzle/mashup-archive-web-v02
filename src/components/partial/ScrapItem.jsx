	...
	renderItem = () => {
		...
		switch (this.props.type) {
			case "url": {
				...
				return (
					<div className="wrap-input wrap-input-url">
						<input type="text" placeholder="type url" onChange={this.props.eventChange} name="url" value={this.props.value} />
			...
			case "check": {
				return (
					<div className="wrap-input wrap-input-check">
			...
			case "text": {
				return (
					<div className="wrap-input wrap-input-text">
						<input type="text" name="title" placeholder="title" onChange={this.props.eventChange} value={this.props.value} />
					</div>
				);
			}
			...
			case "textArea": {
				return (
					<div className="wrap-input wrap-input-textArea">
						<textarea rows="4" name="description" placeholder="description" onChange={this.props.eventChange} value={this.props.value} />
					</div>
				);
			}
			...
			case "tag": {
				return (
					<div className="wrap-input wrap-input-tag">
						<input
							type="text"
							name="tag"
							placeholder="tag"
							value={this.props.value}
							disabled={this.props.tagArr.length === 4 ? true : false}
						...
						<ul className={!this.props.scrapType ? "wrap-tagList" : this.props.scrapType === "design" ? "wrap-tagList design" : "wrap-tagList develop"}>
							{this.props.tagArr.map((el, index) => {
								return (
									<li key={index} onClick={() => this.props.deleteTag(index)}>
										{el}
									</li>
								);
							})}
